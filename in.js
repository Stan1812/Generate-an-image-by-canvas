...
canvas.addEventListener('click',cvs_size_chag);
}
...
function change_(){
    cvs_size_();
    cvs_size_btn.removeEventListener('click',change_,true)
   
}
cvs_size_btn.addEventListener('click',change_,true)
...
function pix_procs(){
  ...
  var data0 = imageData0.data;
    ...
    function negative(){
    	for(var j=0;j<data0.length;j+=4){
    		data0[j]=255-data0[j];
